    ...
    <>
      <div className="p-fileupload-row cursor-pointer" data-pc-section="file">
        ...
        <div data-pc-section="details" style={{ textAlign: "left" }}>
          <div class="p-fileupload-filename" data-pc-section="filename">
            {file.name}
          </div>
          <span data-pc-section="filesize">{file.size} KB</span>
          <span
            class={`p-fileupload-file-badge p-badge p-component ${
              file.status === "Pending" ? "p-badge-warning" : ""
            }`}
            data-pc-name="badge"
        ...
        <div data-pc-section="actions">
          <button
            class="p-button p-component p-button-icon-only p-button-text p-button-rounded p-button-danger"
            type="button"
            data-pc-name="button"
            data-pc-section="root"
            onClick={() => {
              eliminarAdjunto(file.name);
            }}
          >
            <svg
              width="14"
